...
type ColumnInfo struct {
	...
	IsVirtualGencol  bool     `protobuf:"varint,22,opt,name=is_virtual_gencol,json=isVirtualGencol" json:"is_virtual_gencol"`
	XXX_unrecognized []byte   `json:"-"`
}
...
func (m *ColumnInfo) GetIsVirtualGencol() bool {
	if m != nil {
		return m.IsVirtualGencol
	}
	return false
}
...
func (m *ColumnInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 22:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IsVirtualGencol", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorSchema = []byte{
	...
	,
}
